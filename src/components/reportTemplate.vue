...
<style scoped>
                        ...
                        <div class="body">
                            <div class="frame">
                                ...
                                <div class="reportArea">
                                    ...
                                    <div class="daysArea">
                                        <span>1天</span>
                                        <input type="radio" name="days" checked value="1" v-model="radioValue" @click="radioValue=1" />
                                        <span>7天</span>
                                        <input type="radio" name="days" value="7" v-model="radioValue" @click="radioValue=7" />
                                        <span>30天</span>
                                        <input type="radio" name="days" value="30" v-model="radioValue" @click="radioValue=30" />
                                    </div>
                                    <div class="reportTable">
                                        <table cellspacing="0" cellpadding="0">
                                            <thead>
                                            <tr>
                                                <th v-for="item in tableHead" :key="item.text" :style="{ width: item.width }">{{item.text}}</th>
                                            </tr>
                                            </thead>
                                        </table>
                                        <div class="tableContentArea">
                                            <table cellspacing="0" cellpadding="0">
                                                ...
                                                <tr v-for="(item,index) in curPageData" :key="index">
                                                    <td v-for="(value, key, index) in item" :key="index" :style="{ width: tableHead[index].width }">{{value}}</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="reportControl">
                                        <ul>
                                            <li @click="pageAfterClickEvent" :class="curPageIndex == 0 ? 'disable' : ''">上一页</li>
                                            <li @click="pageIndexClickEvent(item)" :class="curPageIndex == item ? 'active' : ''" v-for="(item,index) in curPageArea" :key="index">{{item + 1}}</li>
                                            <li @click="pageNextClickEvent" :class="curPageIndex == pageCount - 1 ? 'disable' : ''">下一页</li>
                                        </ul>
                                    </div>
                                </div>
    ...
    data:function(){
        return{
            ...
            curPageArea: function () {
                var index = this.curPageIndex;
                var op = index - 2;
                if (op < 0) op = 0;
                var ed = index + 2;
                if (ed > this.pageCount - 1) ed = this.pageCount - 1;
                var len = ed - op + 1;
            ...
            curPageData: function () {
                return srcList.slice(this.curPageIndex * 20, this.curPageIndex * 20 + 20);
            },
            pageCount: function () {
                return Math.floor((srcList.length + 19) / 20);
            },
        },
        methods: {                filterNoWarningToday: function () {                    Cab.FilterNoWarningToday();                },
            ...
            //用户自定义方法————————————————————————————————————————————————————————————————————————————————————————————————
            pageAfterClickEvent: function () {
                if (this.curPageIndex > 0)
                    this.curPageIndex--;
            },
            pageIndexClickEvent: function (index) {
                this.curPageIndex = index;
            },
            pageNextClickEvent: function () {
        ...
        watch: {
            curPageIndex: function (newId, oldId) {
                console.log(newId);
            },
        },
    };
